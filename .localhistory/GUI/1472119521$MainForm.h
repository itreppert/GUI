...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tableLayoutPanel8->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &MainForm::tableLayoutPanel8_Paint);
			// 
			// panel10
			// 
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(84, 5);
			this->textBox3->Name = L"textBox3";
			this->textBox3->Size = System::Drawing::Size(335, 20);
			this->textBox3->TabIndex = 7;
			this->textBox3->Text = L"http://www.zeit.de/index";
			// 
			// MainForm
			// 
