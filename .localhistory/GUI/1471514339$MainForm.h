		...
		void InitializeComponent(void)
		{
			...
			this->toolStripMenuItem1->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3)
			{
				this->toolStripMenuItem2,
					this->toolStripSeparator1, this->mnuSaveFileDialog
			});
			...
			this->mnuSaveFileDialog->Size = System::Drawing::Size(152, 22);
			...
			// toolStripMenuItem3
			// 
			this->toolStripMenuItem3->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) { this->mnuFarben });
			...
			this->mnuFarben->Size = System::Drawing::Size(110, 22);
...
#pragma endregion
	...
	private: System::Void mnuSaveFileDialog_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		if (dialogResult == System::Windows::Forms::DialogResult::OK)
		{
			System::IO::File::WriteAllText(saveFileDialog1->FileName,textBox1->TextLength;)
		}
	}
	};
}
