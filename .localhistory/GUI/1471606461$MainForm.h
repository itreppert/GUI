...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pnlDrawing->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &MainForm::pnlDrawing_Paint);
			// 
			// panel6
			// 
			this->panel6->Controls->Add(this->btnDrawImage);
			this->panel6->Controls->Add(this->btnTranslatePoints);
...
#pragma endregion
	...
	private: System::Void pnlDrawing_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		graphics->DrawLine(penRed, lastPoint, actualPosition);
	...
	private: System::Void pnlDrawing_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e)
	{
		drawLinesByPoints(e->Graphics);
			 ...
			 void drawLinesByPoints(Graphics^ g)
			 {
				 ...
				 for (int counter = 0; counter < pointsCount - 1;counter++)				 {					 g->DrawLine(penRed, (Point)points[counter], (Point)points[counter + 1]);				 }
			 }
