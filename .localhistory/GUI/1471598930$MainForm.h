...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnBla = (gcnew System::Windows::Forms::Button());
			...
			// panel4
			// 
			this->panel4->Controls->Add(this->btnBla);
			...
			// btnBla
			// 
			this->btnBla->Location = System::Drawing::Point(84, 205);
			this->btnBla->Name = L"btnBla";
			this->btnBla->Size = System::Drawing::Size(75, 23);
			this->btnBla->TabIndex = 5;
			this->btnBla->Text = L"button1";
			this->btnBla->UseVisualStyleBackColor = true;
			this->btnBla->Click += gcnew System::EventHandler(this, &MainForm::btnBla_Click);
			// 
			// MainForm
			// 
...
#pragma endregion
	...
	private: System::Void btnBla_Click(System::Object^  sender, System::EventArgs^  e)
	{
	}
	};
}
