...
#pragma endregion
	...
	private: System::Void btnCreateClassKundeXmlNode_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		holger->addToKundeVerzeichnisXml(xmlDoc, "Normalkunde");
	}
	private: System::Void btnReadKundeFromKundenVverzeichnisXml_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		for (int counter = 1;counter < 8;counter++)
		{
			...
			anonymous->getFromKundeVerzeichnisXml(sourceKundenverzeichnis);
	...
	private: System::Void btnDeleteKundeFromVerzeichnis_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		armeWurst->id = 7;
		armeWurst->deleteKunde(sourceKundenverzeichnis);
	...
	{
		System::Xml::XmlDocument^ kundenVerzeichnis = Kunde::getEmptyKundenverzeichnisXmlDocument("d:\\Kundenverzeichnis.xml");
		...
		holger->addToKundeVerzeichnisXml(kundenVerzeichnis, "Geschaeftskunden");
	}
};
}
