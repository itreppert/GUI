...
#pragma endregion
		...
		void initialiseComponents()
		{
			...
			// lsvFile
			// 
			this->lsvFile->Columns->AddRange(gcnew cli::array< System::Windows::Forms::ColumnHeader^  >(2) { gcnew ColumnHeader("Name"), gcnew ColumnHeader("Size")
			});
