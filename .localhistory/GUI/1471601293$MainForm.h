...
#pragma endregion
	...
	private: System::Void btnBenchmark_Click(System::Object^  sender, System::EventArgs^  e)
	{
		...
		txtCollections->AppendText("Creation of 1M int in ArrayList :" + endTime.Subtract(startTime).TotalMilliseconds);

		startTime = DateTime::Now;


		array<int>^ intArray = gcnew array<int>(1000000);
		for (int counter = 0; counter < 1000000; counter++)
		{
		...
		txtCollections->AppendText("Creation of 1M int in array :" + endTime.Subtract(startTime).TotalMilliseconds);
