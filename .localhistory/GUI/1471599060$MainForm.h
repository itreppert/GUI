...
private: System::Windows::Forms::Button^  btnBlubb;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnBlubb = (gcnew System::Windows::Forms::Button());
			...
			// panel4
			// 
			this->panel4->Controls->Add(this->btnBlubb);
			...
			// btnBlubb
			// 
			this->btnBlubb->Location = System::Drawing::Point(84, 205);
			this->btnBlubb->Name = L"btnBlubb";
			this->btnBlubb->Size = System::Drawing::Size(75, 23);
			this->btnBlubb->TabIndex = 5;
			this->btnBlubb->Text = L"button1";
			this->btnBlubb->UseVisualStyleBackColor = true;
			this->btnBlubb->Click += gcnew System::EventHandler(this, &MainForm::btnBlubb_Click);
			// 
			// btnHashtable
			// 
...
#pragma endregion
	...
	private: System::Void btnBlubb_Click(System::Object^  sender, System::EventArgs^  e)
	{
	}
	};
}
