...
#pragma endregion
	...
	private: System::Void btnCreateKundeNode_Click(System::Object^  sender, System::EventArgs^  e)
	{
			 ...
			 void addKundeNodeToKundeVerzeichnisXml(String^ vorname, String^ nachname, String^ strasse, String^plz, String^ ort, String^ umsatz, String^ benutzername)
			 {
				 System::Xml::XmlDocument^ kundenVerzeichnisXMLDocument = gcnew System::Xml::XmlDocument();
				 try
				 {
					 ...
					 System::Xml::XmlNode^ targetNode =
						 kundenVerzeichnisXMLDocument->SelectSingleNode("/Kundenverzeichnis/Normalkunden");
