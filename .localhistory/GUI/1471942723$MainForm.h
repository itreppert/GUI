...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->mnuFarben->Size = System::Drawing::Size(152, 22);
			...
			this->mnuSchriftart->Size = System::Drawing::Size(152, 22);
			...
			this->tableLayoutPanel4->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 72.56944F)));
			this->tableLayoutPanel4->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 27.43056F)));
			...
			this->textBox2->Size = System::Drawing::Size(422, 411);
			...
			this->panel5->Size = System::Drawing::Size(422, 411);
...
#pragma endregion
		...
		{
			this->btnBlinkinButton = gcnew BlinkinButton(250,Color::Coral,Color::CornflowerBlue);
			// 
			// btnBlinkinButton
			// 
			...
			this->btnBlinkinButton->color1 = Color::Pink;
			this->btnBlinkinButton->color2 = Color::AliceBlue;
			this->btnBlinkinButton->t->Interval = 500;
