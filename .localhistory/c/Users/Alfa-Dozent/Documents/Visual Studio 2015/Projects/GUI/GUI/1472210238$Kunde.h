...
public:
	...
	{
		System::Xml::XmlDocument^ xmlDocumentToSearch = gcnew System::Xml::XmlDocument;		xmlDocumentToSearch->Load(path);				System::Xml::XmlNode^ idNode= xmlDocumentToSearch->SelectSingleNode("//Kunde/@Id[not(. <=../preceding-sibling::Kunde/@id) and not(. <=../following-sibling::Kunde/@Id)]");		logger->Trace(idNode->InnerText);
