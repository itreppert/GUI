...
public:
	...
	{
		drawHouse(e->Graphics, 0, 0, 0.5, 0.5);
		this->Panel::OnPaint(e);
	}

	void drawHouse(System::Drawing::Graphics^ graphics, int startPositionX, int startPositionY, double scaleFactorX, double scaleFactorY)
	{
	...
	void drawSpecialLine(System::Drawing::Graphics^ graphics, System::Drawing::Pen^ pen, float startPositionX, float startPositionY, float x1, float y1, float x2, float y2, float scaleFactorX, float scaleFactorY)
	{
